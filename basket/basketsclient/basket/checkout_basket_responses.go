...
type CheckoutBasketOK struct {
	Payload models.V1CheckoutBasketResponse
}
...
func (o *CheckoutBasketOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/baskets/{id}/checkout][%d] checkoutBasketOK %s", 200, payload)
}
...
func (o *CheckoutBasketOK) GetPayload() models.V1CheckoutBasketResponse {
	return o.Payload
}
...
func (o *CheckoutBasketDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/baskets/{id}/checkout][%d] checkoutBasket default %s", o._statusCode, payload)
}
