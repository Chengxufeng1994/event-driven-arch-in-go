...
type GetBasketOK struct {
	Payload *models.V1GetBasketResponse
}
...
func (o *GetBasketOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/baskets/{id}][%d] getBasketOK %s", 200, payload)
}
...
func (o *GetBasketDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/baskets/{id}][%d] getBasket default %s", o._statusCode, payload)
}
