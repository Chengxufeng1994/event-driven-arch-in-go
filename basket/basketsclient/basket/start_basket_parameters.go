...
type StartBasketParams struct {
	...
	// Body.
	Body *models.V1StartBasketRequest
...
func (o *StartBasketParams) WithBody(body *models.V1StartBasketRequest) *StartBasketParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the start basket params
func (o *StartBasketParams) SetBody(body *models.V1StartBasketRequest) {
	o.Body = body
}
