...
type StartBasketOK struct {
	Payload *models.V1StartBasketResponse
}
...
func (o *StartBasketOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/baskets][%d] startBasketOK %s", 200, payload)
}
...
func (o *StartBasketOK) GetPayload() *models.V1StartBasketResponse {
	return o.Payload
}
...
func (o *StartBasketOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V1StartBasketResponse)
...
func (o *StartBasketDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/baskets][%d] startBasket default %s", o._statusCode, payload)
}
