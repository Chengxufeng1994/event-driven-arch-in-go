...
type AddItemOK struct {
	Payload models.V1AddItemResponse
}
...
func (o *AddItemOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/baskets/{id}/addItem][%d] addItemOK %s", 200, payload)
}
...
func (o *AddItemOK) GetPayload() models.V1AddItemResponse {
	return o.Payload
}
...
func (o *AddItemDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/baskets/{id}/addItem][%d] addItem default %s", o._statusCode, payload)
}
