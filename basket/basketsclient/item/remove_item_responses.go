...
type RemoveItemOK struct {
	Payload models.V1RemoveItemResponse
}
...
func (o *RemoveItemOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/baskets/{id}/removeItem][%d] removeItemOK %s", 200, payload)
}
...
func (o *RemoveItemOK) GetPayload() models.V1RemoveItemResponse {
	return o.Payload
}
...
func (o *RemoveItemDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/baskets/{id}/removeItem][%d] removeItem default %s", o._statusCode, payload)
}
