...
import (
	...
	"github.com/Chengxufeng1994/event-driven-arch-in-go/basket/internal/application/service"
...
func (m *Module) PrepareRun(ctx context.Context, mono monolith.Monolith) error {
	...
	application := logging.NewLogApplicationAccess(
		service.NewBasketApplication(basketRepository, grpcOrderClient, grpcProductClient, grpcStoreClient),
		mono.Logger())
