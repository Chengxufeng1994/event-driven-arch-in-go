...
const (
	CustomersService_RegisterCustomer_FullMethodName  = "/api.customer.v1.CustomersService/RegisterCustomer"
	CustomersService_EnableCustomer_FullMethodName    = "/api.customer.v1.CustomersService/EnableCustomer"
	CustomersService_DisableCustomer_FullMethodName   = "/api.customer.v1.CustomersService/DisableCustomer"
	CustomersService_ChangeSmsNumber_FullMethodName   = "/api.customer.v1.CustomersService/ChangeSmsNumber"
	CustomersService_AuthorizeCustomer_FullMethodName = "/api.customer.v1.CustomersService/AuthorizeCustomer"
	CustomersService_GetCustomer_FullMethodName       = "/api.customer.v1.CustomersService/GetCustomer"
)
...
var CustomersService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.customer.v1.CustomersService",
