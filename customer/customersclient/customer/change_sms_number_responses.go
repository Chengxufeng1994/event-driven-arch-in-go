...
type ChangeSmsNumberOK struct {
	Payload models.V1ChangeSmsNumberResponse
}
...
func (o *ChangeSmsNumberOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/customers/{id}/change-sms][%d] changeSmsNumberOK %s", 200, payload)
}
...
func (o *ChangeSmsNumberOK) GetPayload() models.V1ChangeSmsNumberResponse {
	return o.Payload
}
...
func (o *ChangeSmsNumberDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/customers/{id}/change-sms][%d] changeSmsNumber default %s", o._statusCode, payload)
}
