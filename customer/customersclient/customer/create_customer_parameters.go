...
func (o *CreateCustomerParams) WithBody(body *models.V1RegisterCustomerRequest) *CreateCustomerParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create customer params
func (o *CreateCustomerParams) SetBody(body *models.V1RegisterCustomerRequest) {
	o.Body = body
}
