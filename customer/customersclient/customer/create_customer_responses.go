...
func (o *CreateCustomerOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/customers][%d] createCustomerOK %s", 200, payload)
}
...
func (o *CreateCustomerOK) GetPayload() *models.V1RegisterCustomerResponse {
	return o.Payload
}
...
func (o *CreateCustomerDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/customers][%d] createCustomer default %s", o._statusCode, payload)
}
