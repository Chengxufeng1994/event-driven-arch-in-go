...
type DisableCustomerOK struct {
	Payload models.V1DisableCustomerResponse
}
...
func (o *DisableCustomerOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/customers/{id}/disable][%d] disableCustomerOK %s", 200, payload)
}
...
func (o *DisableCustomerOK) GetPayload() models.V1DisableCustomerResponse {
	return o.Payload
}
...
func (o *DisableCustomerDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/customers/{id}/disable][%d] DisableCustomer default %s", o._statusCode, payload)
}
