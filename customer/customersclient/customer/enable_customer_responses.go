...
type EnableCustomerOK struct {
	Payload models.V1EnableCustomerResponse
}
...
func (o *EnableCustomerOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/customers/{id}/enable][%d] enableCustomerOK %s", 200, payload)
}
...
func (o *EnableCustomerOK) GetPayload() models.V1EnableCustomerResponse {
	return o.Payload
}
...
func (o *EnableCustomerDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/customers/{id}/enable][%d] enableCustomer default %s", o._statusCode, payload)
}
