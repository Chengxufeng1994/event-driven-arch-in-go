...
func (o *GetCustomerOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/customers/{id}][%d] getCustomerOK %s", 200, payload)
}
...
func (o *GetCustomerOK) GetPayload() *models.V1GetCustomerResponse {
	return o.Payload
}
...
func (o *GetCustomerDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/customers/{id}][%d] getCustomer default %s", o._statusCode, payload)
}
