...
func (o *RegisterCustomerParams) WithBody(body *models.V1RegisterCustomerRequest) *RegisterCustomerParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the register customer params
func (o *RegisterCustomerParams) SetBody(body *models.V1RegisterCustomerRequest) {
	o.Body = body
}
