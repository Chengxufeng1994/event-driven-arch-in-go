...
type RegisterCustomerOK struct {
	Payload *models.V1RegisterCustomerResponse
}
...
func (o *RegisterCustomerOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/customers][%d] registerCustomerOK %s", 200, payload)
}
...
func (o *RegisterCustomerOK) GetPayload() *models.V1RegisterCustomerResponse {
	return o.Payload
}
...
func (o *RegisterCustomerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V1RegisterCustomerResponse)
...
func (o *RegisterCustomerDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/customers][%d] registerCustomer default %s", o._statusCode, payload)
}
