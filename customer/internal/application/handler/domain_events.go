...
func NewDomainEventHandler(publisher am.MessagePublisher[ddd.Event]) *CustomerIntegrationEventHandler[ddd.AggregateEvent] {
	return &CustomerIntegrationEventHandler[ddd.AggregateEvent]{
		publisher: publisher,
	}
}

func RegisterDomainEventHandler(eventHandler ddd.EventHandler[ddd.AggregateEvent], domainSubscriber ddd.EventSubscriber[ddd.AggregateEvent]) {
