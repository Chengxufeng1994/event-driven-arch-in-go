...
const (
	DepotService_CreateShoppingList_FullMethodName   = "/api.depot.v1.DepotService/CreateShoppingList"
	DepotService_CancelShoppingList_FullMethodName   = "/api.depot.v1.DepotService/CancelShoppingList"
	DepotService_AssignShoppingList_FullMethodName   = "/api.depot.v1.DepotService/AssignShoppingList"
	DepotService_CompleteShoppingList_FullMethodName = "/api.depot.v1.DepotService/CompleteShoppingList"
)
...
func (c *depotServiceClient) CreateShoppingList(ctx context.Context, in *CreateShoppingListRequest, opts ...grpc.CallOption) (*CreateShoppingListResponse, error) {
	...
	err := c.cc.Invoke(ctx, DepotService_CreateShoppingList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *depotServiceClient) CancelShoppingList(ctx context.Context, in *CancelShoppingListRequest, opts ...grpc.CallOption) (*CancelShoppingListResponse, error) {
	...
	err := c.cc.Invoke(ctx, DepotService_CancelShoppingList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *depotServiceClient) AssignShoppingList(ctx context.Context, in *AssignShoppingListRequest, opts ...grpc.CallOption) (*AssignShoppingListResponse, error) {
	...
	err := c.cc.Invoke(ctx, DepotService_AssignShoppingList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *depotServiceClient) CompleteShoppingList(ctx context.Context, in *CompleteShoppingListRequest, opts ...grpc.CallOption) (*CompleteShoppingListResponse, error) {
	...
	err := c.cc.Invoke(ctx, DepotService_CompleteShoppingList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterDepotServiceServer(s grpc.ServiceRegistrar, srv DepotServiceServer) {
	// If the following call pancis, it indicates UnimplementedDepotServiceServer was
...
var DepotService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.depot.v1.DepotService",
	...
	Metadata: "api/depot/v1/depot.proto",
}
