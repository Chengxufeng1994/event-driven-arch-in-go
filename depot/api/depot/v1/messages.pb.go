...
func (*CreatedShoppingList) Descriptor() ([]byte, []int) {
	return file_api_depot_v1_messages_proto_rawDescGZIP(), []int{4}
}
...
func (x *CreateShoppingList_Item) Reset() {
	*x = CreateShoppingList_Item{}
	mi := &file_api_depot_v1_messages_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateShoppingList_Item) Descriptor() ([]byte, []int) {
	return file_api_depot_v1_messages_proto_rawDescGZIP(), []int{1, 0}
}
...
var file_api_depot_v1_messages_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x2e, 0x64, 0x65, 0x70, 0x6f, 0x74, 0x2e, 0x76, 0x31, 0x22, 0x42, 0x0a, 0x15, 0x53,
	0x68, 0x6f, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c,
	...
	0xca, 0x01, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x68, 0x6f, 0x70, 0x70, 0x69,
	0x6e, 0x67, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49,
	0x64, 0x12, 0x3b, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x25, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x64, 0x65, 0x70, 0x6f, 0x74, 0x2e, 0x76, 0x31, 0x2e,
	...
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x42, 0xc6, 0x01,
	0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x64, 0x65, 0x70, 0x6f, 0x74, 0x2e,
...
var file_api_depot_v1_messages_proto_goTypes = []any{
	(*ShoppingListCompleted)(nil),   // 0: api.depot.v1.ShoppingListCompleted
	(*CreateShoppingList)(nil),      // 1: api.depot.v1.CreateShoppingList
	(*CancelShoppingList)(nil),      // 2: api.depot.v1.CancelShoppingList
	(*InitiateShopping)(nil),        // 3: api.depot.v1.InitiateShopping
	(*CreatedShoppingList)(nil),     // 4: api.depot.v1.CreatedShoppingList
	(*CreateShoppingList_Item)(nil), // 5: api.depot.v1.CreateShoppingList.Item
}
var file_api_depot_v1_messages_proto_depIdxs = []int32{
	5, // 0: api.depot.v1.CreateShoppingList.items:type_name -> api.depot.v1.CreateShoppingList.Item
