...
import (
	...
	"github.com/Chengxufeng1994/event-driven-arch-in-go/depot/migrations"
...
func run() (err error) {
	...
	s, err := system.NewSystem("MALL BOTS", "mallbots-depot", cfg, log)
	if err != nil {
	...
	log.Info("started depot service")
	defer log.Info("stopped depot service")
