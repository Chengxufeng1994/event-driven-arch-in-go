...
type AssignShoppingListOK struct {
	Payload models.V1AssignShoppingListResponse
}
...
func (o *AssignShoppingListOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/depots/shopping/{id}/assign][%d] assignShoppingListOK %s", 200, payload)
}
...
func (o *AssignShoppingListOK) GetPayload() models.V1AssignShoppingListResponse {
	return o.Payload
}
...
func (o *AssignShoppingListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/depots/shopping/{id}/assign][%d] assignShoppingList default %s", o._statusCode, payload)
}
