...
type CancelShoppingListParams struct {
	...
	// Body.
	Body models.V1DepotServiceCancelShoppingListBody
...
func (o *CancelShoppingListParams) WithBody(body models.V1DepotServiceCancelShoppingListBody) *CancelShoppingListParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the cancel shopping list params
func (o *CancelShoppingListParams) SetBody(body models.V1DepotServiceCancelShoppingListBody) {
	o.Body = body
}
