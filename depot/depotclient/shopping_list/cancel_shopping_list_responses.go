...
type CancelShoppingListOK struct {
	Payload models.V1CancelShoppingListResponse
}
...
func (o *CancelShoppingListOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/depots/shopping/{id}][%d] cancelShoppingListOK %s", 200, payload)
}
...
func (o *CancelShoppingListOK) GetPayload() models.V1CancelShoppingListResponse {
	return o.Payload
}
...
func (o *CancelShoppingListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/depots/shopping/{id}][%d] cancelShoppingList default %s", o._statusCode, payload)
}
