...
type CreateShoppingListParams struct {
	...
	// Body.
	Body *models.V1CreateShoppingListRequest
...
func (o *CreateShoppingListParams) WithBody(body *models.V1CreateShoppingListRequest) *CreateShoppingListParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create shopping list params
func (o *CreateShoppingListParams) SetBody(body *models.V1CreateShoppingListRequest) {
	o.Body = body
}
