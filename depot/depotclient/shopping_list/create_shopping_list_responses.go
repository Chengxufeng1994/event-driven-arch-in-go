...
type CreateShoppingListOK struct {
	Payload *models.V1CreateShoppingListResponse
}
...
func (o *CreateShoppingListOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/depots/shopping][%d] createShoppingListOK %s", 200, payload)
}
...
func (o *CreateShoppingListOK) GetPayload() *models.V1CreateShoppingListResponse {
	return o.Payload
}
...
func (o *CreateShoppingListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V1CreateShoppingListResponse)
...
func (o *CreateShoppingListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/depots/shopping][%d] createShoppingList default %s", o._statusCode, payload)
}
