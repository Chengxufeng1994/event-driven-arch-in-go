...
import (
	...
	entity "github.com/Chengxufeng1994/event-driven-arch-in-go/depot/internal/domain/entity"
...
func (_m *MockProductCacheRepository) Find(ctx context.Context, productID string) (*entity.Product, error) {
