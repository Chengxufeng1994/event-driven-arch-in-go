...
// Publish provides a mock function with given fields: ctx, topicName, command
func (_m *MockCommandPublisher) Publish(ctx context.Context, topicName string, command ddd.Command) error {
	ret := _m.Called(ctx, topicName, command)
