...
func setDefaults() {
	...
	viper.SetDefault("infrastructure.gorm.dsn", "host=localhost user=postgres password=postgres dbname=postgres port=5432 sslmode=disable TimeZone=Asia/Taipei")
