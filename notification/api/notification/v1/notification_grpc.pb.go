...
const (
	NotificationsService_NotifyOrderCreated_FullMethodName  = "/api.notification.v1.NotificationsService/NotifyOrderCreated"
	NotificationsService_NotifyOrderCanceled_FullMethodName = "/api.notification.v1.NotificationsService/NotifyOrderCanceled"
	NotificationsService_NotifyOrderReady_FullMethodName    = "/api.notification.v1.NotificationsService/NotifyOrderReady"
)
...
func (c *notificationsServiceClient) NotifyOrderCreated(ctx context.Context, in *NotifyOrderCreatedRequest, opts ...grpc.CallOption) (*NotifyOrderCreatedResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotificationsService_NotifyOrderCreated_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationsServiceClient) NotifyOrderCanceled(ctx context.Context, in *NotifyOrderCanceledRequest, opts ...grpc.CallOption) (*NotifyOrderCanceledResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotificationsService_NotifyOrderCanceled_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationsServiceClient) NotifyOrderReady(ctx context.Context, in *NotifyOrderReadyRequest, opts ...grpc.CallOption) (*NotifyOrderReadyResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotificationsService_NotifyOrderReady_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var NotificationsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.notification.v1.NotificationsService",
