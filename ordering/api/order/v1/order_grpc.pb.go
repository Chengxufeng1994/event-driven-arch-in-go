...
const (
	OrderingService_CreateOrder_FullMethodName   = "/api.order.v1.OrderingService/CreateOrder"
	OrderingService_GetOrder_FullMethodName      = "/api.order.v1.OrderingService/GetOrder"
	OrderingService_CancelOrder_FullMethodName   = "/api.order.v1.OrderingService/CancelOrder"
	OrderingService_ReadyOrder_FullMethodName    = "/api.order.v1.OrderingService/ReadyOrder"
	OrderingService_CompleteOrder_FullMethodName = "/api.order.v1.OrderingService/CompleteOrder"
)
...
var OrderingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.order.v1.OrderingService",
