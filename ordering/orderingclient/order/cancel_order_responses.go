...
type CancelOrderOK struct {
	Payload models.V1CancelOrderResponse
}
...
func (o *CancelOrderOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/ordering/{id}][%d] cancelOrderOK %s", 200, payload)
}
...
func (o *CancelOrderOK) GetPayload() models.V1CancelOrderResponse {
	return o.Payload
}
...
func (o *CancelOrderDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/ordering/{id}][%d] cancelOrder default %s", o._statusCode, payload)
}
