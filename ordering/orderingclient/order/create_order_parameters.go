...
type CreateOrderParams struct {
	...
	// Body.
	Body *models.V1CreateOrderRequest
...
func (o *CreateOrderParams) WithBody(body *models.V1CreateOrderRequest) *CreateOrderParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create order params
func (o *CreateOrderParams) SetBody(body *models.V1CreateOrderRequest) {
	o.Body = body
}
