...
import (
	...
	"github.com/Chengxufeng1994/event-driven-arch-in-go/ordering/orderingclient/models"
)
...
type CreateOrderOK struct {
	Payload *models.V1CreateOrderResponse
}
...
func (o *CreateOrderOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/ordering][%d] createOrderOK %s", 200, payload)
}
...
func (o *CreateOrderOK) GetPayload() *models.V1CreateOrderResponse {
	return o.Payload
}
...
func (o *CreateOrderOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V1CreateOrderResponse)
...
func (o *CreateOrderDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/ordering][%d] createOrder default %s", o._statusCode, payload)
}
