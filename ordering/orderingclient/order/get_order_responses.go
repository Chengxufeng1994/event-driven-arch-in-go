...
type GetOrderOK struct {
	Payload *models.V1GetOrderResponse
}
...
func (o *GetOrderOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/ordering/{id}][%d] getOrderOK %s", 200, payload)
}
...
func (o *GetOrderDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/ordering/{id}][%d] getOrder default %s", o._statusCode, payload)
}
