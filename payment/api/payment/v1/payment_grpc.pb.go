...
const (
	PaymentsService_AuthorizePayment_FullMethodName = "/api.payment.v1.PaymentsService/AuthorizePayment"
	PaymentsService_ConfirmPayment_FullMethodName   = "/api.payment.v1.PaymentsService/ConfirmPayment"
	PaymentsService_CreateInvoice_FullMethodName    = "/api.payment.v1.PaymentsService/CreateInvoice"
	PaymentsService_AdjustInvoice_FullMethodName    = "/api.payment.v1.PaymentsService/AdjustInvoice"
	PaymentsService_PayInvoice_FullMethodName       = "/api.payment.v1.PaymentsService/PayInvoice"
	PaymentsService_CancelInvoice_FullMethodName    = "/api.payment.v1.PaymentsService/CancelInvoice"
)
...
var PaymentsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.payment.v1.PaymentsService",
