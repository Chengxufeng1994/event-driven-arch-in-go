...
type PayInvoiceOK struct {
	Payload models.V1PayInvoiceResponse
}
...
func (o *PayInvoiceOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/payments/invoices/{id}/pay][%d] payInvoiceOK %s", 200, payload)
}
...
func (o *PayInvoiceOK) GetPayload() models.V1PayInvoiceResponse {
	return o.Payload
}
...
func (o *PayInvoiceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/payments/invoices/{id}/pay][%d] payInvoice default %s", o._statusCode, payload)
}
