...
func (o *AuthorizePaymentParams) WithBody(body *models.V1AuthorizePaymentRequest) *AuthorizePaymentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the authorize payment params
func (o *AuthorizePaymentParams) SetBody(body *models.V1AuthorizePaymentRequest) {
	o.Body = body
}
