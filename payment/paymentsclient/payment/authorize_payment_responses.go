...
type AuthorizePaymentOK struct {
	Payload *models.V1AuthorizePaymentResponse
}
...
func (o *AuthorizePaymentOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/payments][%d] authorizePaymentOK %s", 200, payload)
}
...
func (o *AuthorizePaymentOK) GetPayload() *models.V1AuthorizePaymentResponse {
	return o.Payload
}
...
func (o *AuthorizePaymentOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V1AuthorizePaymentResponse)
...
func (o *AuthorizePaymentDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/payments][%d] authorizePayment default %s", o._statusCode, payload)
}
