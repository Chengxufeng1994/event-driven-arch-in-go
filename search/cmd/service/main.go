...
import (
	...
	"github.com/Chengxufeng1994/event-driven-arch-in-go/search/migrations"
)
...
func run() (err error) {
	...
	s, err := system.NewSystem("MALL BOTS", "mallbots-search", cfg, log)
	if err != nil {
	...
	log.Info("started search service")
	defer log.Info("stopped search service")
