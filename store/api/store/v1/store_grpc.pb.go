...
const (
	StoresService_CreateStore_FullMethodName            = "/api.store.v1.StoresService/CreateStore"
	StoresService_EnableParticipation_FullMethodName    = "/api.store.v1.StoresService/EnableParticipation"
	StoresService_DisableParticipation_FullMethodName   = "/api.store.v1.StoresService/DisableParticipation"
	StoresService_RebrandStore_FullMethodName           = "/api.store.v1.StoresService/RebrandStore"
	StoresService_GetStore_FullMethodName               = "/api.store.v1.StoresService/GetStore"
	StoresService_GetStores_FullMethodName              = "/api.store.v1.StoresService/GetStores"
	StoresService_GetParticipatingStores_FullMethodName = "/api.store.v1.StoresService/GetParticipatingStores"
	StoresService_AddProduct_FullMethodName             = "/api.store.v1.StoresService/AddProduct"
	StoresService_RebrandProduct_FullMethodName         = "/api.store.v1.StoresService/RebrandProduct"
	StoresService_IncreaseProductPrice_FullMethodName   = "/api.store.v1.StoresService/IncreaseProductPrice"
	StoresService_DecreaseProductPrice_FullMethodName   = "/api.store.v1.StoresService/DecreaseProductPrice"
	StoresService_RemoveProduct_FullMethodName          = "/api.store.v1.StoresService/RemoveProduct"
	StoresService_GetProduct_FullMethodName             = "/api.store.v1.StoresService/GetProduct"
	StoresService_GetCatalog_FullMethodName             = "/api.store.v1.StoresService/GetCatalog"
)
...
var StoresService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.store.v1.StoresService",
	...
	Metadata: "api/store/v1/store.proto",
}
