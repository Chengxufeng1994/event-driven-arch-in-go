...
func (_m *MockCatalogRepository) Find(ctx context.Context, productID string) (*aggregate.CatalogProduct, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*aggregate.CatalogProduct, error)); ok {
		return rf(ctx, productID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *aggregate.CatalogProduct); ok {
		r0 = rf(ctx, productID)
	} else {
		if ret.Get(0) != nil {
...
func (_m *MockCatalogRepository) GetCatalog(ctx context.Context, storeID string) ([]*aggregate.CatalogProduct, error) {
