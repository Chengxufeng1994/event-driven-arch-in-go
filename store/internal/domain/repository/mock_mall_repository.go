...
func (_m *MockMallRepository) All(ctx context.Context) ([]*aggregate.MallStore, error) {
	ret := _m.Called(ctx)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]*aggregate.MallStore, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []*aggregate.MallStore); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
...
func (_m *MockMallRepository) AllParticipating(ctx context.Context) ([]*aggregate.MallStore, error) {
	ret := _m.Called(ctx)
...
func (_m *MockMallRepository) Find(ctx context.Context, storeID string) (*aggregate.MallStore, error) {
	...
	var r0 *aggregate.MallStore
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*aggregate.MallStore, error)); ok {
		return rf(ctx, storeID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *aggregate.MallStore); ok {
		r0 = rf(ctx, storeID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*aggregate.MallStore)
