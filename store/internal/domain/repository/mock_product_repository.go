...
func (_m *MockProductRepository) Load(ctx context.Context, id string) (*aggregate.Product, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*aggregate.Product, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *aggregate.Product); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
...
func (_m *MockProductRepository) Save(ctx context.Context, product *aggregate.Product) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *aggregate.Product) error); ok {
		r0 = rf(ctx, product)
	} else {
		r0 = ret.Error(0)
	}
