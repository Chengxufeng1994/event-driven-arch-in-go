...
func (_m *MockStoreRepository) Load(ctx context.Context, storeID string) (*aggregate.Store, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*aggregate.Store, error)); ok {
		return rf(ctx, storeID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *aggregate.Store); ok {
		r0 = rf(ctx, storeID)
	} else {
		if ret.Get(0) != nil {
...
func (_m *MockStoreRepository) Save(ctx context.Context, store *aggregate.Store) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *aggregate.Store) error); ok {
		r0 = rf(ctx, store)
	} else {
		r0 = ret.Error(0)
	}
