...
func (a Application) RebrandStore(ctx context.Context, cmd command.RebrandStore) (err error) {
	a.logger.Info("--> Stores.RebrandStore")
	defer func() { a.logger.WithError(err).Info("<-- Stores.RebrandStore") }()
	return a.StoreUseCase.RebrandStore(ctx, cmd)
}
...
func (a Application) RebrandProduct(ctx context.Context, cmd command.RebrandProduct) (err error) {
	a.logger.Info("--> Stores.RebrandProduct")
	defer func() { a.logger.WithError(err).Info("<-- Stores.RebrandProduct") }()
	return a.StoreUseCase.RebrandProduct(ctx, cmd)
}

func (a Application) GetStore(ctx context.Context, query query.GetStore) (store *aggregate.MallStore, err error) {
...
func (a Application) GetStores(ctx context.Context, query query.GetStores) (store []*aggregate.MallStore, err error) {
...
func (a Application) GetParticipatingStores(ctx context.Context, query query.GetParticipatingStores) (store []*aggregate.MallStore, err error) {
...
func (a Application) GetCatalog(ctx context.Context, query query.GetCatalog) (products []*aggregate.CatalogProduct, err error) {
...
func (a Application) GetProduct(ctx context.Context, query query.GetProduct) (product *aggregate.CatalogProduct, err error) {
...
func (a Application) IncreaseProductPrice(ctx context.Context, cmd command.IncreaseProductPrice) (err error) {
	a.logger.Info("--> Stores.IncreaseProductPrice")
	a.logger.WithError(err).Info("<-- Stores.IncreaseProductPrice")
	return a.StoreUseCase.IncreaseProductPrice(ctx, cmd)
}

func (a Application) DecreaseProductPrice(ctx context.Context, cmd command.DecreaseProductPrice) (err error) {
	a.logger.Info("--> Stores.DecreaseProductPrice")
	defer func() { a.logger.WithError(err).Info("<-- Stores.DecreaseProductPrice") }()
	return a.StoreUseCase.DecreaseProductPrice(ctx, cmd)
}
