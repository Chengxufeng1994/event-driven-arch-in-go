...
type DisableParticipationOK struct {
	Payload models.V1DisableParticipationResponse
}
...
func (o *DisableParticipationOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/stores/{id}/participating][%d] disableParticipationOK %s", 200, payload)
}
...
func (o *DisableParticipationOK) GetPayload() models.V1DisableParticipationResponse {
	return o.Payload
}
...
func (o *DisableParticipationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/stores/{id}/participating][%d] disableParticipation default %s", o._statusCode, payload)
}
