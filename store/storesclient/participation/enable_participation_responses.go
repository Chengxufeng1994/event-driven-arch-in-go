...
type EnableParticipationOK struct {
	Payload models.V1EnableParticipationResponse
}
...
func (o *EnableParticipationOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/stores/{id}/participating][%d] enableParticipationOK %s", 200, payload)
}
...
func (o *EnableParticipationOK) GetPayload() models.V1EnableParticipationResponse {
	return o.Payload
}
...
func (o *EnableParticipationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/stores/{id}/participating][%d] enableParticipation default %s", o._statusCode, payload)
}
