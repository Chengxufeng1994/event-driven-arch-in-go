...
type GetParticipatingStoresOK struct {
	Payload *models.V1GetParticipatingStoresResponse
}
...
func (o *GetParticipatingStoresOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/stores/participating][%d] getParticipatingStoresOK %s", 200, payload)
}
...
func (o *GetParticipatingStoresOK) GetPayload() *models.V1GetParticipatingStoresResponse {
	return o.Payload
}
...
func (o *GetParticipatingStoresOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V1GetParticipatingStoresResponse)
...
func (o *GetParticipatingStoresDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/stores/participating][%d] getParticipatingStores default %s", o._statusCode, payload)
}
