...
type AddProductOK struct {
	Payload *models.V1AddProductResponse
}
...
func (o *AddProductOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/stores/{storeId}/products][%d] addProductOK %s", 200, payload)
}
...
func (o *AddProductDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/stores/{storeId}/products][%d] addProduct default %s", o._statusCode, payload)
}
