...
type DecreaseProductPriceOK struct {
	Payload models.V1DecreaseProductPriceResponse
}
...
func (o *DecreaseProductPriceOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/stores/products/{id}/decreasePrice][%d] decreaseProductPriceOK %s", 200, payload)
}
...
func (o *DecreaseProductPriceOK) GetPayload() models.V1DecreaseProductPriceResponse {
	return o.Payload
}
...
func (o *DecreaseProductPriceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/stores/products/{id}/decreasePrice][%d] decreaseProductPrice default %s", o._statusCode, payload)
}
