...
func (o *GetProductOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/stores/products/{id}][%d] getProductOK %s", 200, payload)
}
...
func (o *GetProductOK) GetPayload() *models.V1GetProductResponse {
	return o.Payload
}
...
func (o *GetProductDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/stores/products/{id}][%d] getProduct default %s", o._statusCode, payload)
}
