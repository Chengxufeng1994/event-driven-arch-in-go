...
func (o *GetStoreProductOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/stores/{storeId}/products][%d] getStoreProductOK %s", 200, payload)
}
...
func (o *GetStoreProductOK) GetPayload() *models.V1GetCatalogResponse {
	return o.Payload
}
...
func (o *GetStoreProductDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/stores/{storeId}/products][%d] getStoreProduct default %s", o._statusCode, payload)
}
