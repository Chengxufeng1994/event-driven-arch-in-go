...
type GetStoreProductsOK struct {
	Payload *models.V1GetCatalogResponse
}
...
func (o *GetStoreProductsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/stores/{storeId}/products][%d] getStoreProductsOK %s", 200, payload)
}
...
func (o *GetStoreProductsOK) GetPayload() *models.V1GetCatalogResponse {
	return o.Payload
}
...
func (o *GetStoreProductsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V1GetCatalogResponse)
...
func (o *GetStoreProductsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/stores/{storeId}/products][%d] getStoreProducts default %s", o._statusCode, payload)
}
