...
type RebrandProductOK struct {
	Payload models.V1RebrandProductResponse
}
...
func (o *RebrandProductOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/stores/products/{id}/rebrand][%d] rebrandProductOK %s", 200, payload)
}
...
func (o *RebrandProductOK) GetPayload() models.V1RebrandProductResponse {
	return o.Payload
}
...
func (o *RebrandProductDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/stores/products/{id}/rebrand][%d] rebrandProduct default %s", o._statusCode, payload)
}
