...
type RemoveProductOK struct {
	Payload models.V1RemoveProductResponse
}
...
func (o *RemoveProductOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/stores/products/{id}][%d] removeProductOK %s", 200, payload)
}
...
func (o *RemoveProductOK) GetPayload() models.V1RemoveProductResponse {
	return o.Payload
}
...
func (o *RemoveProductDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/stores/products/{id}][%d] removeProduct default %s", o._statusCode, payload)
}
