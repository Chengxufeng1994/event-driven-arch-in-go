...
type CreateStoreOK struct {
	Payload *models.V1CreateStoreResponse
}
...
func (o *CreateStoreOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/stores][%d] createStoreOK %s", 200, payload)
}
...
func (o *CreateStoreOK) GetPayload() *models.V1CreateStoreResponse {
	return o.Payload
}
...
func (o *CreateStoreOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V1CreateStoreResponse)
...
func (o *CreateStoreDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/stores][%d] createStore default %s", o._statusCode, payload)
}
