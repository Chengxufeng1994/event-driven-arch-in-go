...
type GetStoreOK struct {
	Payload *models.V1GetStoreResponse
}
...
func (o *GetStoreOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/stores/{id}][%d] getStoreOK %s", 200, payload)
}
...
func (o *GetStoreDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/stores/{id}][%d] getStore default %s", o._statusCode, payload)
}
