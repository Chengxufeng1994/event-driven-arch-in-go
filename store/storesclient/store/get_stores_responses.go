...
type GetStoresOK struct {
	Payload *models.V1GetStoresResponse
}
...
func (o *GetStoresOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/stores][%d] getStoresOK %s", 200, payload)
}
...
func (o *GetStoresDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/stores][%d] getStores default %s", o._statusCode, payload)
}
